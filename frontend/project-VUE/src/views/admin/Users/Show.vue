                ...
                <div class="card shadow-lg border-0 rounded-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="list-group" v-else-if="users.role === 'manager'">
                                <li v-for="project in users.manager_project" :key="project.id" class="list-group-item d-flex justify-content-between align-items-center">
                                    <span>
                                        <i class="bi bi-folder2-open me-2"></i>
                                        {{ project.name }}
                                    </span>
                    ...
                    <div class="card-footer bg-white border-0">
                        <div class="d-flex justify-content-between">
                            ...
                            <RouterLink :to="{ name:'admin.edit.users', params:{ id:users.id } }" class="btn btn-warning">
        ...
        data() {
            return {
                ...
                users: {
                    ...
                    description: '',
                    projects: [],  
                    //v-for="project in users.manager_project"
