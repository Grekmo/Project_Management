            ...
            <div class="card-body p-4">
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <select class="form-select" v-model="task.project_id" disabled>
                            <option v-for="project in projects" :key="project.id" :value="project.id" disabled >
                                {{ project.name }}
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <select class="form-select" v-model="task.assigned_to" disabled>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="date" class="form-control" v-model="task.end_date" disabled>
                    </div>
                </div>

                <div class="d-flex justify-content-between mt-4">
                    <RouterLink :to="{ name: 'employee.myTasks' }" class="btn btn-outline-secondary px-4">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            updateTask(taskID) {
                api.put(`/employee/tasks/${taskID}`, this.task)
                .then( res => {
                    console.log(res.data);
                    this.errorList = {};
                    toast.success(res.data.message);
                    this.$router.push({ name: 'employee.myTasks' });
                })
                .catch( error => {
            ...
            getEmployees() {
                api.get('/employee/employees-list')
                .then( res => {
                    console.log(res.data);
            ...
            getProjects(){
                ...
                .then( res => {
                    this.projects = res.data.myProjects;
                })
                .catch( error => {
                    console.log(error.response.data.message);
                })
