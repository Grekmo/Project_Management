        ...
        <div class="card shadow-lg border-0 rounded-4">
            ...
            <div class="card-body">
                ...
                <div class="mt-4 d-flex justify-content-end gap-2">
                    <RouterLink :to="{ name: 'manager.tasks' }" class="btn btn-outline-secondary">
                        Back
                    </RouterLink>
                    <RouterLink :to="{ name: 'manager.edit.tasks', params: { id:task.id } }" class="btn btn-warning">
