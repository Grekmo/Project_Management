    ...
    export default {
        ...
        methods: {
            ...
            closeTaskModal() {
                ...
                console.log(this.showTaskModal);
            },

            updateTask() {
                this.task.project_id = this.projectID;
                api.put(`/manager/tasks/${this.task.id}`, this.task)
                .then( res => {
            ...
            getEmployees() {
                api.get('/manager/employees-list')
                .then( res => {
            ...
            getProject(projectID){
                api.get(`/manager/projects/${projectID}`)
                .then( res => {
                    ...
                    // map(employee => employee.id)  hiya LOOP Katrje3 liya mn kol employee l ID dyalo 
            ...
            updateProject(projectID){
                ...
                api.put(`/manager/projects/${projectID}`, this.projects)
                .then( res => {
                    console.log(res.data);
                    this.errorList = {}; 
                    toast.success(res.data.message);
                    this.$router.push( {name: 'manager.myProjects' });
                })
                .catch(error => {
